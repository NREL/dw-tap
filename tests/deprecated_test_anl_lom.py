...
#import dw_tap_data 
#
#def read_in_all_obstacles():
#    obs = AllObstacles(data_dir=dw_tap_data.path, types=["bergey", "oneenergy"])
#
#    print(len(obs.obstacles))
#
#    assert(len(obs.obstacles) == 1,
#         "Output should be: %d" % len(obs.obstacles))
#
#def get_obstacle_subsets_for_bergey_and_one_energy_examples():
#    obs = AllObstacles(data_dir=dw_tap_data.path, types=["bergey", "oneenergy"])
#    obs.get("bergey", "t024")
#    obs.get("bergey", "t024", "treesasbldgs_100m")
#    obs.get("bergey", "t024", "bldgsonly")
#    obs.get("bergey", "t024", "bldgsonly_100m")
#    obs.get("oneenergy", "p1w1")
#    obs.get("oneenergy", "p1w1", "treesasbldgs_100m")
#    obs.get("oneenergy", "p1w1", "bldgsonly")
#    obs.get("oneenergy", "p1w1", "bldgsonly_100m")
#
# Older tests below
